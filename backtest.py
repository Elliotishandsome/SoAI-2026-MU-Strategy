...
# ---------------------------------------------------------------------------
# Strategy selection - the official entrypoint strategy (VWAP 回踩波段).
# ---------------------------------------------------------------------------
...
# For minute-mode runs with freshly downloaded CSVs, leave as None so the
# harness uses the full available data range automatically.
