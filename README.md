...
## 三層決策架構（v2.1 — RS 相對強弱 + MTF 大趨勢過濾）

### MTF 大趨勢過濾（v2.1 新增）
- 將 5 分鐘 K 線重取樣為 **1H K 線**，計算 1H 20-EMA
- **僅當 1H 收盤價 > 1H EMA20（大趨勢向上）時，5 分鐘買入訊號才有效**
- 1H 空頭排列 → 5 分鐘所有買入訊號一律作廢（避免「一波流陷阱」）
- 5 分鐘的突破若無大級別趨勢支撐 = 7–8 月下跌市頻繁虧損的主因
